...
desafio.
*/
var teams = ['São Paulo', 'Santos', 'Corinthians', 'Palmeiras', 'Ituano'];
...
function showTeamPosition(pos){
    ...
    return 'O time quem está em ' + pos + 'º é o ' + teams[pos - 1] + '.';
}
...
function convertToHex(cor){
    switch(cor) {
        ...
        case 'azul':
            ...
            break;
        case 'rosa':
            console.log('O hexadecimal para a cor ' + cor + ' é #FF01EF.');
            break;    
        case 'amarelo':
            console.log('O hexadecimal para a cor ' + cor + ' é #FBFF4D.');
            break;
        default:
